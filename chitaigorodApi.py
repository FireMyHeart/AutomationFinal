...
token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczovL3VzZXItcmlnaHQiLCJzdWIiOjIwOTI3Mzg3LCJpYXQiOjE3MjA3MjIzNTgsImV4cCI6MTcyMDcyNTk1OCwidHlwZSI6MjB9.DTWFr1vy0e0QYqx0n-H24Jd2FS8x1p2bvvwZDTQf3XI'
...
class chitaigorodApi:
    ...
    def delete_all(self):
        my_headers = {}
        my_headers['Authorization'] = f"Bearer {token}"
        resp = requests.delete(self.url+'v1/cart/', headers=my_headers)
        return resp.status_code
